...
const UserComponent = () => {
    ...
    const getUsersFromAPI = () => {
        return setLoading(true), fetch(`https://api.github.com/search/users?q=a&per_page=10&page=${currentPage}`)
        ...
        return (
            <View style={styles.itemWrapper}>
                ...
                <View style={styles.contentWrapper}>
                    <Text style={styles.txtIdStyle}>ID: {item.id}</Text>
                </View>
            </View>
        );
    };
